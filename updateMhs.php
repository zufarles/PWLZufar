	...
	if ($kosong){
		...
		while($row=mysqli_fetch_assoc($hasil)){
			...
			<tr>
				...
				<a href="inputKRS.php?nim=<?php echo $row["nim"]?>"class="btn 
				btn-info btn-sm">Input KRS</a>
				<a href="cetakpdf.php?type=krs$param=<?php echo $row ["nim"]?>"
				class="btn btn-secondary btn-sm">Cetak KRS</a>
				</td>
			</tr>
			<?php 
			$no++;
